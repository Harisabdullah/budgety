...
var budgetController = (function(){
	...
	return {
		...
		calculateBudget: function(){
			...
			// calculate the persentage of income that we have spent
...
var UIController = (function(){
	...
	var formatNumber = function(num, type){
		...
		*/
		...
		int = numSplit[0];
		if(int.length > 3){
			int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3); // 3210 -> 3,210
		}
		dec = numSplit[1];
...
var controller = (function(budgetCtrl, UICtrl){
	...
	var ctrlAddItem = function(){
		...
		if(input.description.trim() !== "" /* && /\S/.test(input.description)*/ && !isNaN(input.value) && input.value > 0){
